...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        dataprovider: function(options) {
            var optionDOM = "";
            var selected = options.allSelected === true ? 'selected="selected"' : '';
            var dataprovider  = options.data;
            dataprovider.forEach(function(option) {
                if ($.isArray(option.value))
                {
                    optionDOM += '<optgroup label="' + option.label + '">';
                    option.value.forEach(function(opt) {
                        optionDOM += '<option value="' + opt.value + '" ' + selected +'>' + opt.label + '</option>';
                    });
                    optionDOM += '</optgroup>';
                }
                else
